...
<html lang="es" dir="ltr">
  <head>
    <meta charset="utf-8">
      ...
      <title>Admisión | PowerBridge</title>
      <!-- Favicon -->
        ...
        <nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
            ...
            <div class="container-fluid">
               ...
               <ul class="navbar-nav">
                  <?php 
                  require_once '../Permissions/intomenus.php';
                  $menus = getUserMenus($mysqli, $id_user, $id_menu);
                  if (empty($menus)) {
                     error_log('No menus returned for user ' . $id_user.' '.$username.' '.$surname);
                 }
                 echo $menus;
                  ?>
               </ul>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
               <li class="nav-item dropdown">
                  <a href="../index.php"  class="nav-link" id="notification-drop">
...
<div class="row">
                  ...
                  <div class="card-body">
                     <div class="progress-widget">
                        ...
                        <div class="progress-detail">
                           ...
                           <h4 class="counter">Admisiones</h4>
                        </div>
                     </div>
                  </div>
               </li>
         ...
         <div class="col-md-12 col-lg-12">
            <div class="card">
               ...
               <div class="card-body">
                  ...
                  if (empty($options)) {
                     error_log('No options returned for user ' . $id_user.' '.$usrname.' '.$surname);
                 }
                 echo $options;
                  ?>
   ...
   <div class="col-md-12 col-lg-10">
         <div class="iframe-container">
            <iframe name="frame-cont"  frameborder="0" sandbox="allow-forms allow-scripts allow-same-origin"></iframe>
         </div>
   </div> 
</div>
</div>
